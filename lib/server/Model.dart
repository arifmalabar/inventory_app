...
class Model {
  ...
  void postBarang() {
    ...
    var request = http.Request(
        'POST', Uri.parse('http://192.168.1.9/core_hmvc/barang/insertData'));
    request.bodyFields = {
      'nama': nama_barang,
      'stok': stok,
      'deskripsi': deskripsi
  ...
  Future<void> deleteBarang(var id) async {
    final response =
        await http.get("http://192.168.1.9/core_hmvc/barang/hapusData/$id");
  }
  ...
  Future<void> updateBarang(var id) async {
    ...
    var request = http.Request('POST',
        Uri.parse('http://192.168.1.9/core_hmvc/barang/updateData/$id'));
    request.bodyFields = {
      'nama': nama_barang,
      'stok': stok,
      'deskripsi': deskripsi
